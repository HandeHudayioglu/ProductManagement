package com.handehdy.northwind.business.concretes;
...
import com.handehdy.northwind.core.utilities.results.SuccessDataResult;
import com.handehdy.northwind.core.utilities.results.SuccessResult;
...
public class ProductManager implements ProductService {
    ...
    public DataResult<List<Product>> getAllSorted() {
        Sort sort = Sort.by(Sort.Direction.DESC,"productName");   //productname e göre tersten sırala
